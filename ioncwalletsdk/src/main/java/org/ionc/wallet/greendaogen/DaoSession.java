...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig currentPageNumDaoConfig;
    ...
    private final CurrentPageNumDao currentPageNumDao;
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        currentPageNumDaoConfig = daoConfigMap.get(CurrentPageNumDao.class).clone();
        currentPageNumDaoConfig.initIdentityScope(type);
        ...
        currentPageNumDao = new CurrentPageNumDao(currentPageNumDaoConfig, this);
        ...
        registerDao(CurrentPageNum.class, currentPageNumDao);
    }
    ...
    public void clear() {
        ...
        currentPageNumDaoConfig.clearIdentityScope();
    }
    ...
    public CurrentPageNumDao getCurrentPageNumDao() {
        return currentPageNumDao;
    }
