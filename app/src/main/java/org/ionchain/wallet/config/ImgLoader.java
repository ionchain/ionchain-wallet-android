...
import com.fast.lib.glideimageloader.LoaderListener;
...
public class ImgLoader {
    ...
    public static ImageLoadConfig defConfig = new ImageLoadConfig.Builder().
            ...
            setAsBitmap(true).
            setColorFilter(0).
            setPlaceHolderResId(com.fast.lib.R.mipmap.bga_pp_ic_holder_dark).
            setErrorResId(com.fast.lib.R.mipmap.bga_pp_ic_holder_dark).
    ...
    private static void load(Context context, ImageView view, final Object objUrl, ImageLoadConfig config, final LoaderListener listener) {
        if (null == objUrl) {
        ...
        try {
            ...
            RequestBuilder<Drawable> builder = GlideApp.with(context)
                    .load(objUrl)
                    .apply(options)
                    .listener(new RequestListener() {
                        ...
                        public boolean onResourceReady(Object resource, Object model, Target target, DataSource dataSource, boolean isFirstResource) {
                            if(listener != null){
                                Logger.i("objUrl==>"+objUrl.toString());
