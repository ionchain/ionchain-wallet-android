package org.ionchain.wallet.comm.constants;
...
public class Comm extends LibComm {
    ...
    public static final String SDCARD_IMG_ROOT = "ionchain/img";

    public static final String DEF_IMAG = "android.resource://com.jurong.film/mipmap/" + R.mipmap.def_img_lib;
    ...
    public static final int article_refresh_type = 1002;
