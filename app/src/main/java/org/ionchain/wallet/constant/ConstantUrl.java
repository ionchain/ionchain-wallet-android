...
public class ConstantUrl {
    ...
    public final static String URL_USD_EX_RATE_RMB_PRICE = HOST_PRICE + "/v2/currency";   //人民币兑美元汇率
    public final static String URL_TX_RECORD_GET = HOST_PRICE + "/v1/transaction";   //交易记录

    public final static String HOST_NODE_MAIN = "https://api.ionchain.org";
...
//    public final static String HOST_NODE_MAIN_DEBUG = "http:///192.168.1.8:7545";
    public final static String HOST_NODE_MAIN_DEBUG = "http://172.16.10.88:8545";
