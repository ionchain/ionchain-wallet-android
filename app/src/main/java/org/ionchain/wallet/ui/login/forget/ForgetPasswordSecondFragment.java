...
public class ForgetPasswordSecondFragment extends BaseFragment implements TextWatcher {
    ...
    public static ForgetPasswordSecondFragment newInstance(String mobile) {
    ...
    private void replaceFragment(String mobile,String verifyCode) {
        FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
        FragmentTransaction transaction = fragmentManager.beginTransaction();
        ForgetPasswordThirdFragment forgetPasswordThirdFragment = ForgetPasswordThirdFragment.newInstance(mobile, verifyCode);
        transaction.add(R.id.register_container, forgetPasswordThirdFragment)
                .hide(ForgetPasswordSecondFragment.this).show(forgetPasswordThirdFragment);
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        for (int i = 0; i < arr.length; i++) {
            if (i == 0) {
                ...
                replaceFragment(mMobileStr, hideEtStr);
                showKeyboard(false);
            }
        }
    }
