package org.ionc.wallet.view.widget.dialog.more;
...
public class MoreWalletDialog extends AbsBaseDialog {
     ...
     * @return 本实例
     */
    public MoreWalletDialog setMoreWalletListItemClickedLisenter(OnMoreWalletDialogItemClickedListener listener) {
