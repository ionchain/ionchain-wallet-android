...
public class ImageLoadConfig {
    ...
    private boolean isCropTransformation;
    ...
    public enum DiskCache {
        ...
        SOURCE(DiskCacheStrategy.RESOURCE),//仅仅保存原始分辨率的图片
        RESULT(DiskCacheStrategy.DATA),//仅仅缓存最终分辨率的图像(降低分辨率后的或者转换后的)
    ...
    private ImageLoadConfig(ImageLoadConfig.Builder builder) {
        ...
        this.isCropTransformation = builder.isCropTransformation;
        this.tag = tag;
    }
    /**
     *Builder类
    ...
    public static class Builder {
        ...
        public Builder setCropTransformation(boolean isCropTransformation) {
            this.isCropTransformation = isCropTransformation;
            return this;
        }
    ...
    public static Builder parseBuilder(ImageLoadConfig config) {
        ...
        builder.isCropTransformation = config.isCropTransformation;
        return builder;
    }
    ...
    public boolean isCropTransformation() {
        return isCropTransformation;
    }
