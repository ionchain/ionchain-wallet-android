...
public class ImmersionBar {
     ...
     * 状态栏颜色
     *
     * @param statusBarDrawable 状态栏颜色，资源文件（R.drawabe.xxx）
     */
    public ImmersionBar statusBarDrawableInt(@DrawableRes int statusBarDrawable) {
        mBarParams.statusBarDrawable = statusBarDrawable;
        return this;
    }
    ...
    private int initBarAboveLOLLIPOP(int uiFlags) {
        ...
        if(mBarParams.statusBarDrawable != 0)
            mWindow.setBackgroundDrawableResource(mBarParams.statusBarDrawable);
        else if (mBarParams.titleBarView == null || mBarParams.statusBarFlag)
    ...
    private void setupStatusBarView() {
        ...
        if(mBarParams.statusBarDrawable != 0)
            mBarParams.statusBarView.setBackgroundResource(mBarParams.statusBarDrawable);
        else if (mBarParams.titleBarView == null || mBarParams.statusBarFlag)
    ...
    public BarConfig getBarConfig(){return mConfig;}
