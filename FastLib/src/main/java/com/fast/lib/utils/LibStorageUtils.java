 ...
 *
 * @author Sergey Tarasevich ([at]gmail[dot]com)
 * @since 1.0.0
 */
public class LibStorageUtils {

    private static final String EXTERNAL_STORAGE_PERMISSION = "android.permission.WRITE_EXTERNAL_STORAGE";
    private static final String INDIVIDUAL_DIR_NAME = "glide-images";
    ...
    private static File getExternalFilesDir(Context context) {
        ...
        if (!appCacheDir.exists()) {
            if (!appCacheDir.mkdirs()) {
                Logger.w("Unable to create external files directory");
                return null;
            }
            try {
                new File(appCacheDir, ".nomedia").createNewFile();
            } catch (IOException e) {
                Logger.e("Can't create \".nomedia\" file in application external files directory");
            }
        }
        return appCacheDir;
    }
